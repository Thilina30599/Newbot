...
Amazone.addCommand({ pattern: 'publicbot ?(.*)', fromMe: false, dontAddCommandList:true}, async (message, match) => {
...
Amazone.addCommand({ pattern: 'publicbot ?(.*)', fromMe: true, desc: Lang.BR_DESC}, async (message, match) => {
